...
# Set Up
```{r}
setwd("C:\\Users\\ARAYA ABADI\\OneDrive")
...
plot(TotalEtelAsIs_stl)
plot(EfakAsIs_stl)
plot(WugeAsIs_stl)
plot(TotalEtelAsIs_stl)
plot(BlueEtelAsIs_stl)
plot(RedEtelAsIs_stl)
```
